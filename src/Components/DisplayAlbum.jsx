    ...
    <>
      ...
      <div className="mt-10 flex gap-8 flex-col md:flex-row md:items-end">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-1">
            ...
            <b>Spotify</b> • 1,323,154 likes • <b>50 songs,</b> about 2 hours 30 minutes
          </p>
        </div>
      </div>
      ...
      {songsData.map((item, index) => (
        <div
          ...
          key={index}
          className="grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-center text-[#a7a7a7] hover:bg-[#fffff2] cursor-pointer"
        >
